    ...
    curr_align_state(UNALIGNED)
{
  ...
  nh_private.param("app_id",        app_id,    1065898);
  nh_private.param("app_version",   app_version, 1);
  nh_private.param("enc_key",       enc_key, std::string("22068c869d010b2dc1256929a1805d9bb2210d1a800b0fc60b14ad360dcc3ed8"));
  nh_private.param("drone_version", drone_version, std::string("M600")); // choose M100 as default

...
bool runHotpointMission(int initialRadius, int responseTimeout)
{
  ...
  ROS_INFO("Update radius to 1.5x: new radius = %f", 10 * initialRadius);
  if (hotpointUpdateRadius(10 * initialRadius).result)
  {
...
int main(int argc, char **argv)
{
  ...
  hotpoint_updateRadius_service = nh.serviceClient<dji_sdk::MissionHpUpdateRadius>("dji_sdk/mission_hotpoint_updateRadius");
  hotpoint_update_yawRate_Service = nh.serviceClient<dji_sdk::MissionHpUpdateYawRate>("dji_sdk/mission_hotpoint_updateYawRate");
